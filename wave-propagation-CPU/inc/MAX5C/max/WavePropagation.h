 ...
 * \param [in] instream_absorb The stream should be of size ( ( param_nx * ( param_nz - 8)) * 4) bytes.
 * \param [in] instream_curr The stream should be of size ( ( param_nx * ( param_nz - 2)) * 4) bytes.
 * \param [in] instream_density The stream should be of size ( ( param_nx * ( param_nz - 2)) * 4) bytes.
 * \param [in] instream_prev The stream should be of size ( ( param_nx * ( param_nz - 8)) * 4) bytes.
 * \param [in] instream_velocity The stream should be of size ( ( param_nx * ( param_nz - 8)) * 4) bytes.
 * \param [out] outstream_nxt The stream should be of size ( ( param_nx * ( param_nz - 8)) * 4) bytes.
 */
...
typedef struct { 
	...
	int64_t param_nx; /**<  [in] Interface Parameter "nx". */
	int64_t param_nz; /**<  [in] Interface Parameter "nz". */
	const float *instream_absorb; /**<  [in] The stream should be of size ( ( param_nx * ( param_nz - 8)) * 4) bytes. */
	const float *instream_curr; /**<  [in] The stream should be of size ( ( param_nx * ( param_nz - 2)) * 4) bytes. */
	const float *instream_density; /**<  [in] The stream should be of size ( ( param_nx * ( param_nz - 2)) * 4) bytes. */
	const float *instream_prev; /**<  [in] The stream should be of size ( ( param_nx * ( param_nz - 8)) * 4) bytes. */
	const float *instream_velocity; /**<  [in] The stream should be of size ( ( param_nx * ( param_nz - 8)) * 4) bytes. */
	float *outstream_nxt; /**<  [out] The stream should be of size ( ( param_nx * ( param_nz - 8)) * 4) bytes. */
